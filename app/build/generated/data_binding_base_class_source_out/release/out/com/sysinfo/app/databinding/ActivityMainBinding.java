...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNav, @NonNull LinearLayout header,
      @NonNull View headerDivider, @NonNull FragmentContainerView navHostFragment,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, bottomNav, header, headerDivider,
          navHostFragment, tvVersion);
    }
